package com.maixuanviet.permissions.custom;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ini ini = Ini.fromResourcePath(Main.class.getResource("/com/maixuanviet/shiro/permissions/custom/shiro.ini").getPath());
        realm.setIni(ini);
